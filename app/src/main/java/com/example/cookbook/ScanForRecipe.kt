...
class ScanForRecipe : AppCompatActivity(), View.OnClickListener {
    companion object {
    ...
    private lateinit var captureImageFab2: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_scan_for_recipe)

        supportActionBar?.setTitle("Scan Image For Recipe")
